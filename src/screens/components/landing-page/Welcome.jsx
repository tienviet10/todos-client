...
const Welcome = () => {
  ...
  return (
    <div className="wrapper bg-[#081730] flex items-center justify-between px-[3rem] sm:px-[5rem] rounded-b-[5rem] w-[100%] h-[35rem] relative z-[3]">
      <div className="flex flex-row max-w-[1100px] w-full mx-auto text-center justify-center">
        {/* left */}
        ...
        {/* right */}
        <div className="hidden lg:block w-[50%] max-w-lg p-4 ">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 747.62 526">
            <g
              id="Group_33"
              data-name="Group 33"
